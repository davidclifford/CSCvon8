...
# Using hi-res VGA text June 2020

#define printstr(x)  LHA x; STO A strptr; LCA x; STO A strptr+1; JSR puts
#define putc(x)	     LCA x; JOU .; OUT A; STO A __schar; STO B temp; JSR sys_spchar; LDA __schar; LDB temp
#define getc(x)	     JIU .; INA; STO A x
#define JOUT(x)	     JOU .; OUT x
#define JOUTA	     JOU .; OUT A; STO A __schar; STO B temp; JSR sys_spchar; LDA __schar; LDB temp
#define JINA	     JIU .; INA
