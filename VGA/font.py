...
def video_print(x, y, text, fcol, bcol):
...
video_print(0, 0, 'The quick brown fox jumps', (0xFF, 0, 0), (0, 0, 0xFF))
video_print(0, 8, 'over the lazy dog!', (0xFF, 0, 0), (0, 0, 0xFF))
video_print(0, 16, 'THE QUICK BROWN FOX JUMPS', (0xFF, 0xFF, 0), (0, 0x80, 0))
video_print(0, 24, 'OVER THE LAZY DOG?', (0xFF, 0xFF, 0), (0, 0x80, 0))
video_print(0, 32, '123456789 123456789 123456789', (0x40, 0x40, 0x40), (0x80, 0x80, 0x80))
